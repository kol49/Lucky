...
from profitmap.db.models import Base, FixedExpense, Product, ProductKit, ProductSupply, SaleRecord, VariableExpense
...
def migrate_database(engine) -> None:
    ...
    if "sales" in table_names:
        ...
        with engine.begin() as connection:
            ...
            if "sale_channel" not in sales_columns:
                connection.execute(text("ALTER TABLE sales ADD COLUMN sale_channel VARCHAR(32) DEFAULT ''"))
